        ...
        for situation in situations:
            ...
            for team in teams:         
                ...
                for player in team_players:                               
                    ...
                    ### faceoffs
                    event = 'Faceoff'
                    FO_all = (pbp_situation_df[(pbp_situation_df['EVENT'] == event) & (pbp_situation_df['PLAYER_A'] == player)].count()[1] +
                                pbp_situation_df[(pbp_situation_df['EVENT'] == event) & (pbp_situation_df['PLAYER_B'] == player)].count()[1])
                    FO_5v5 = (pbp_situation_df[(pbp_situation_df['EVENT'] == event) & (pbp_situation_df[team_strength] == '5v5') & (pbp_situation_df['PLAYER_A'] == player)].count()[1] +
                    ...
                    FO_PP = (pbp_situation_df[(pbp_situation_df['EVENT'] == event) & (pbp_situation_df[team_state] == 'PP') & (pbp_situation_df['PLAYER_A'] == player)].count()[1] +
                                pbp_situation_df[(pbp_situation_df['EVENT'] == event) & (pbp_situation_df[team_state] == 'PP') & (pbp_situation_df['PLAYER_B'] == player)].count()[1])
                    FO_SH = (pbp_situation_df[(pbp_situation_df['EVENT'] == event) & (pbp_situation_df[team_state] == 'SH') & (pbp_situation_df['PLAYER_A'] == player)].count()[1] +
                                pbp_situation_df[(pbp_situation_df['EVENT'] == event) & (pbp_situation_df[team_state] == 'SH') & (pbp_situation_df['PLAYER_B'] == player)].count()[1])
    
                    FOW_all = pbp_situation_df[(pbp_situation_df['TEAM'] == team) & (pbp_situation_df['EVENT'] == event) & (pbp_situation_df['PLAYER_A'] == player)].count()[1]
                    FOW_5v5 = pbp_situation_df[(pbp_situation_df['TEAM'] == team) & (pbp_situation_df['EVENT'] == event) & (pbp_situation_df[team_strength] == '5v5') & (pbp_situation_df['PLAYER_A'] == player)].count()[1]
                    FOW_PP = pbp_situation_df[(pbp_situation_df['TEAM'] == team) & (pbp_situation_df['EVENT'] == event) & (pbp_situation_df[team_state] == 'PP') & (pbp_situation_df['PLAYER_A'] == player)].count()[1]
                    FOW_SH = pbp_situation_df[(pbp_situation_df['TEAM'] == team) & (pbp_situation_df['EVENT'] == event) & (pbp_situation_df[team_state] == 'SH') & (pbp_situation_df['PLAYER_A'] == player)].count()[1]
