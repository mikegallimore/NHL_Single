...
def parse_ids(season_id, game_id, images):
    ...
    for team in teams:
        ...
        try:
            line1_SF_plot = team_line1_matchups_lines_df.plot.barh(x='MATCHUP', y='SF', stacked=True, color=line1_matchups_lines_toi_color_map_for, width=0.5, legend=None, label='', ax=axarr[0]);
        except:
            pass
        try:
            line1_SA_plot = team_line1_matchups_lines_df.plot.barh(x='MATCHUP', y='SA', stacked=True, color=line1_matchups_lines_toi_color_map_against, width=0.5, legend=None, label='', ax=axarr[0]);
        except:
            pass
        try:
            line1_SD_plot = team_line1_matchups_lines_df.plot(x='SD', y='RANK', marker='o', color='white', markersize=7, markeredgecolor='black', linewidth=0, alpha=1, legend=None, label='', ax=axarr[0]);
        except:
            pass

        try:
            line2_SF_plot = team_line2_matchups_lines_df.plot.barh(x='MATCHUP', y='SF', stacked=True, color=line2_matchups_lines_toi_color_map_for, width=0.5, legend=None, label='', ax=axarr[1]);
        except:
            pass
        try:
            line2_SA_plot = team_line2_matchups_lines_df.plot.barh(x='MATCHUP', y='SA', stacked=True, color=line2_matchups_lines_toi_color_map_against, width=0.5, legend=None, label='', ax=axarr[1]);
        except:
            pass
        try:
            line2_SD_plot = team_line2_matchups_lines_df.plot(x='SD', y='RANK', marker='o', color='white', markersize=7, markeredgecolor='black', linewidth=0, alpha=1, legend=None, label='', ax=axarr[1]);
        except:
            pass

        try:
            line3_SF_plot = team_line3_matchups_lines_df.plot.barh(x='MATCHUP', y='SF', stacked=True, color=line3_matchups_lines_toi_color_map_for, width=0.5, legend=None, label='', ax=axarr[2]);
        except:
            pass
        try:
            line3_SA_plot = team_line3_matchups_lines_df.plot.barh(x='MATCHUP', y='SA', stacked=True, color=line3_matchups_lines_toi_color_map_against, width=0.5, legend=None, label='', ax=axarr[2]);
        except:
            pass
        try:
            line3_SD_plot = team_line3_matchups_lines_df.plot(x='SD', y='RANK', marker='o', color='white', markersize=7, markeredgecolor='black', linewidth=0, alpha=1, legend=None, label='', ax=axarr[2]);
        except:
            pass

        try:
            line4_SF_plot = team_line4_matchups_lines_df.plot.barh(x='MATCHUP', y='SF', stacked=True, color=line4_matchups_lines_toi_color_map_for, width=0.5, legend=None, label='', ax=axarr[3]);
        except:
            pass
        try:
            line4_SA_plot = team_line4_matchups_lines_df.plot.barh(x='MATCHUP', y='SA', stacked=True, color=line4_matchups_lines_toi_color_map_against, width=0.5, legend=None, label='', ax=axarr[3]);
        except:
            pass
        try:
            line4_SD_plot = team_line4_matchups_lines_df.plot(x='SD', y='RANK', marker='o', color='white', markersize=7, markeredgecolor='black', linewidth=0, alpha=1, legend=None, label='', ax=axarr[3]);
        except:
            pass
        ...
        SF_max = team_lines_matchups_lines_df['SF']
        SF_max = SF_max.max()
        SA_max = team_lines_matchups_lines_df['SA']
        SA_max *= -1
        SA_max = SA_max.max()
        ...
        line1_color_bar.ax.set_yticklabels(['0', '', max_line1_matchups_lines_toi], fontsize=10)
        ...
        line2_color_bar.ax.set_yticklabels(['0', '', max_line2_matchups_lines_toi], fontsize=10)
        ...
        line3_color_bar.ax.set_yticklabels(['0', '', max_line3_matchups_lines_toi], fontsize=10)
        ...
        line4_color_bar.ax.set_yticklabels(['0', '', max_line4_matchups_lines_toi], fontsize=10)
        line4_color_bar.set_label('TOI', rotation=270, fontsize=10)
   
        ### save the image to file
        if team == away:
            plt.savefig(charts_units + 'onice_shots_away_lines_matchups_lines.png', bbox_inches='tight', pad_inches=0.2)
        elif team == home:
            plt.savefig(charts_units + 'onice_shots_home_lines_matchups_lines.png', bbox_inches='tight', pad_inches=0.2)    
