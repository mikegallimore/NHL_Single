...
def parse_ids(season_id, game_id, images):
    ...
    for team in teams:
        ...
        team_lines_matchups_lines_df['GF'] = team_lines_matchups_lines_df['GF'].replace(0, np.NaN)       
        team_lines_matchups_lines_df['GA'] = team_lines_matchups_lines_df['GA'].replace(0, np.NaN)

        # remove zeros from the differential column       
        team_lines_matchups_lines_df['SD'] = team_lines_matchups_lines_df['SD'].replace(0, np.NaN)       

        # make shots against negative values
        team_lines_matchups_lines_df['GA'] *= -1
        team_lines_matchups_lines_df['SA'] *= -1
        ...
        # set the plot title
        fig.suptitle(date + ' Lines vs. Lines On-Ice Shots\n\n')
        ...
        try:
            line1_SF_plot = team_line1_matchups_lines_df.plot.barh(x='MATCHUP', y='SF', stacked=True, color=line1_matchups_lines_toi_color_map_for, width=line1_width, legend=None, label='', ax=ax_line1_shots);
        except:
            pass
        try:
            line1_SA_plot = team_line1_matchups_lines_df.plot.barh(x='MATCHUP', y='SA', stacked=True, color=line1_matchups_lines_toi_color_map_against, width=line1_width, legend=None, label='', ax=ax_line1_shots);
        except:
            pass
        try:
            line1_GF_marker = team_line1_matchups_lines_df.plot(x='GF', y='RANK', marker='D', markersize=5,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_line1_shots);
        except:
            pass
        try:
            line1_GA_marker = team_line1_matchups_lines_df.plot(x='GA', y='RANK', marker='D', markersize=5,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_line1_shots);
        except:
            pass
        try:
            line1_SD_plot = team_line1_matchups_lines_df.plot(x='SD', y='RANK', marker='|', markersize=15,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_line1_shots);
        except:
            pass

        try:
            line2_SF_plot = team_line2_matchups_lines_df.plot.barh(x='MATCHUP', y='SF', stacked=True, color=line2_matchups_lines_toi_color_map_for, width=line2_width, legend=None, label='', ax=ax_line2_shots);
        except:
            pass
        try:
            line2_SA_plot = team_line2_matchups_lines_df.plot.barh(x='MATCHUP', y='SA', stacked=True, color=line2_matchups_lines_toi_color_map_against, width=line2_width, legend=None, label='', ax=ax_line2_shots);
        except:
            pass
        try:
            line2_GF_marker = team_line2_matchups_lines_df.plot(x='GF', y='RANK', marker='D', markersize=5,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_line2_shots);
        except:
            pass
        try:
            line2_GA_marker = team_line2_matchups_lines_df.plot(x='GA', y='RANK', marker='D', markersize=5,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_line2_shots);
        except:
            pass

        try:
            line2_SD_plot = team_line2_matchups_lines_df.plot(x='SD', y='RANK', marker='|', markersize=15,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_line2_shots);
        except:
            pass

        try:
            line3_SF_plot = team_line3_matchups_lines_df.plot.barh(x='MATCHUP', y='SF', stacked=True, color=line3_matchups_lines_toi_color_map_for, width=line3_width, legend=None, label='', ax=ax_line3_shots);
        except:
            pass
        try:
            line3_SA_plot = team_line3_matchups_lines_df.plot.barh(x='MATCHUP', y='SA', stacked=True, color=line3_matchups_lines_toi_color_map_against, width=line3_width, legend=None, label='', ax=ax_line3_shots);
        except:
            pass
        try:
            line3_GF_marker = team_line3_matchups_lines_df.plot(x='GF', y='RANK', marker='D', markersize=5,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_line3_shots);
        except:
            pass
        try:
            line3_GA_marker = team_line3_matchups_lines_df.plot(x='GA', y='RANK', marker='D', markersize=5,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_line3_shots);
        except:
            pass
        try:
            line3_SD_plot = team_line3_matchups_lines_df.plot(x='SD', y='RANK', marker='|', markersize=15,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_line3_shots);
        except:
            pass

        if len(team_line4_list) != 0:
                try:
                    line4_SF_plot = team_line4_matchups_lines_df.plot.barh(x='MATCHUP', y='SF', stacked=True, color=line4_matchups_lines_toi_color_map_for, width=line4_width, legend=None, label='', ax=ax_line4_shots);
                except:
                    pass
                try:
                    line4_SA_plot = team_line4_matchups_lines_df.plot.barh(x='MATCHUP', y='SA', stacked=True, color=line4_matchups_lines_toi_color_map_against, width=line4_width, legend=None, label='', ax=ax_line4_shots);
                except:
                    pass
                try:
                    line4_GF_marker = team_line4_matchups_lines_df.plot(x='GF', y='RANK', marker='D', markersize=5,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_line4_shots);
                except:
                    pass
                try:
                    line4_GA_marker = team_line4_matchups_lines_df.plot(x='GA', y='RANK', marker='D', markersize=5,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_line4_shots);
                except:
                    pass
                try:
                    line4_SD_plot = team_line4_matchups_lines_df.plot(x='SD', y='RANK', marker='|', markersize=15,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_line4_shots);
                except:
                    pass
        ...
        SF_max = lines_matchups_lines_df['SF']
        SF_max = SF_max.max()
        
        SA_max = lines_matchups_lines_df['SA']
        SA_max = SA_max.max()
        ...
        if team == away:
            plt.savefig(charts_units_lines_matchups + 'onice_shots_away_lines_matchups_lines.png', bbox_inches='tight', pad_inches=0.2)
        elif team == home:
            plt.savefig(charts_units_lines_matchups + 'onice_shots_home_lines_matchups_lines.png', bbox_inches='tight', pad_inches=0.2)    
        ...
        # status update
        print('Plotting ' + team + ' lines vs. lines 5v5 on-ice shots.')   
        
    # status update
    print('Finished plotting the 5v5 on-ice shots for lines vs. lines.')