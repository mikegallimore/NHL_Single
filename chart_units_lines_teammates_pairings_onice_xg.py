...
def parse_ids(season_id, game_id, images):
    ...
    for team in teams:
        ...
        team_lines_teammates_pairings_df['xGA'] *= -1
        ...
        max_line1_teammates_pairings_toi = max(line1_teammates_pairings_toi)    
        line1_teammates_pairings_toi_color = line1_teammates_pairings_toi / float(max(line1_teammates_pairings_toi))

        line2_teammates_pairings_toi = team_line2_teammates_pairings_df['TOI']
        max_line2_teammates_pairings_toi = max(line2_teammates_pairings_toi)    
        line2_teammates_pairings_toi_color = line2_teammates_pairings_toi / float(max(line2_teammates_pairings_toi))

        line3_teammates_pairings_toi = team_line3_teammates_pairings_df['TOI']
        max_line3_teammates_pairings_toi = max(line3_teammates_pairings_toi)    
        line3_teammates_pairings_toi_color = line3_teammates_pairings_toi / float(max(line3_teammates_pairings_toi))

        try:
            line4_teammates_pairings_toi = team_line4_teammates_pairings_df['TOI']
            max_line4_teammates_pairings_toi = max(line4_teammates_pairings_toi)    
            line4_teammates_pairings_toi_color = line4_teammates_pairings_toi / float(max(line4_teammates_pairings_toi))
        except:
            pass
        ...
        # set the plot title
        fig.suptitle(date + ' Lines + Pairings Expected Goals\n\n')
        ...
        # create bars for expected goals for and against as well as line markers (to note the xG differential) for each line
        try:
            line1_xGF_plot = team_line1_teammates_pairings_df.plot.barh(x='PAIRING', y='xGF', stacked=True, color=line1_teammates_pairings_toi_color_map_for, width=line1_width, legend=None, label='', ax=ax_line1_xG);
        except:
            pass
        try:
            line1_xGA_plot = team_line1_teammates_pairings_df.plot.barh(x='PAIRING', y='xGA', stacked=True, color=line1_teammates_pairings_toi_color_map_against, width=line1_width, legend=None, label='', ax=ax_line1_xG);
        except:
            pass
        try:
            line1_xGD_plot = team_line1_teammates_pairings_df.plot(x='xGD', y='RANK', marker='|', markersize=15,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_line1_xG);
        except:
            pass

        try:
            line2_xGF_plot = team_line2_teammates_pairings_df.plot.barh(x='PAIRING', y='xGF', stacked=True, color=line2_teammates_pairings_toi_color_map_for, width=line2_width, legend=None, label='', ax=ax_line2_xG);
        except:
            pass
        try:
            line2_xGA_plot = team_line2_teammates_pairings_df.plot.barh(x='PAIRING', y='xGA', stacked=True, color=line2_teammates_pairings_toi_color_map_against, width=line2_width, legend=None, label='', ax=ax_line2_xG);
        except:
            pass
        try:
            line2_xGD_plot = team_line2_teammates_pairings_df.plot(x='xGD', y='RANK', marker='|', markersize=15,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_line2_xG);
        except:
            pass

        try:
            line3_xGF_plot = team_line3_teammates_pairings_df.plot.barh(x='PAIRING', y='xGF', stacked=True, color=line3_teammates_pairings_toi_color_map_for, width=line3_width, legend=None, label='', ax=ax_line3_xG);
        except:
            pass
        try:
            line3_xGA_plot = team_line3_teammates_pairings_df.plot.barh(x='PAIRING', y='xGA', stacked=True, color=line3_teammates_pairings_toi_color_map_against, width=line3_width, legend=None, label='', ax=ax_line3_xG);
        except:
            pass
        try:
            line3_xGD_plot = team_line3_teammates_pairings_df.plot(x='xGD', y='RANK', marker='|', markersize=15,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_line3_xG);
        except:
            pass

        if len(team_line4_list) != 0:
            try:
                line4_xGF_plot = team_line4_teammates_pairings_df.plot.barh(x='PAIRING', y='xGF', stacked=True, color=line4_teammates_pairings_toi_color_map_for, width=line4_width, legend=None, label='', ax=ax_line4_xG);
            except:
                pass
            try:
                line4_xGA_plot = team_line4_teammates_pairings_df.plot.barh(x='PAIRING', y='xGA', stacked=True, color=line4_teammates_pairings_toi_color_map_against, width=line4_width, legend=None, label='', ax=ax_line4_xG);
            except:
                pass
            try:
                line4_xGD_plot = team_line4_teammates_pairings_df.plot(x='xGD', y='RANK', marker='|', markersize=15,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_line4_xG);
            except:
                pass
        ...
        xGF_max = lines_teammates_pairings_df['xGF']
        xGF_max = xGF_max.max()
        xGA_max = lines_teammates_pairings_df['xGA']
        xGA_max = xGA_max.max()
        ...
        if team == away:
            plt.savefig(charts_units_lines_teammates + 'onice_xg_away_lines_teammates_pairings.png', bbox_inches='tight', pad_inches=0.2)
        elif team == home:
            plt.savefig(charts_units_lines_teammates + 'onice_xg_home_lines_teammates_pairings.png', bbox_inches='tight', pad_inches=0.2)    
        ...
        # status update
        print('Plotting ' + team + ' lines with pairings 5v5 on-ice xG.')   
        
    # status update
    print('Finished plotting the 5v5 on-ice xG for lines with pairings.')