...
def parse_ids(season_id, game_id, images):
    ...
    for team in teams:
        ...
        max_lines_toi = team_lines_matchups_pairings_df['TOI'].max()
        ...
        try:
            ...
            team_line4_list = team_line4_matchups_pairings_df.MATCHUP.unique()                     
        except:
            pass

        # create lists for use in determining the differential marker size
        team_line1_matchups_pairings_list = team_line1_matchups_pairings_df.MATCHUP.unique()
        team_line2_matchups_pairings_list = team_line2_matchups_pairings_df.MATCHUP.unique()
        team_line3_matchups_pairings_list = team_line3_matchups_pairings_df.MATCHUP.unique()
        team_line4_matchups_pairings_list = team_line4_matchups_pairings_df.MATCHUP.unique()

        if len(team_line1_matchups_pairings_list) >= 6:
            line1_width = .8
        elif len(team_line1_matchups_pairings_list) == 5:
            line1_width = .7
        elif len(team_line1_matchups_pairings_list) == 4:
            line1_width = .6
        elif len(team_line1_matchups_pairings_list) == 3:
            line1_width = .5
        elif len(team_line1_matchups_pairings_list) == 2:
            line1_width = .3
        elif len(team_line1_matchups_pairings_list) == 1:
            line1_width = .2      

        if len(team_line2_matchups_pairings_list) >= 6:
            line2_width = .8
        elif len(team_line2_matchups_pairings_list) == 5:
            line2_width = .7
        elif len(team_line2_matchups_pairings_list) == 4:
            line2_width = .6
        elif len(team_line2_matchups_pairings_list) == 3:
            line2_width = .5
        elif len(team_line2_matchups_pairings_list) == 2:
            line2_width = .3
        elif len(team_line2_matchups_pairings_list) == 1:
            line2_width = .2

        if len(team_line3_matchups_pairings_list) >= 6:
            line3_width = .8
        elif len(team_line3_matchups_pairings_list) == 5:
            line3_width = .7
        elif len(team_line3_matchups_pairings_list) == 4:
            line3_width = .6
        elif len(team_line3_matchups_pairings_list) == 3:
            line3_width = .5
        elif len(team_line3_matchups_pairings_list) == 2:
            line3_width = .3
        elif len(team_line3_matchups_pairings_list) == 1:
            line3_width = .2   

        if len(team_line4_matchups_pairings_list) >= 6:
            line4_width = .8
        elif len(team_line4_matchups_pairings_list) == 5:
            line4_width = .7
        elif len(team_line4_matchups_pairings_list) == 4:
            line4_width = .6
        elif len(team_line4_matchups_pairings_list) == 3:
            line4_width = .5
        elif len(team_line4_matchups_pairings_list) == 2:
            line4_width = .3
        elif len(team_line4_matchups_pairings_list) == 1:
            line4_width = .2
        ...
        # set the plot title
        fig.suptitle(date + ' Lines vs. Pairings On-Ice Shots\n\n')
        ...
        try:
            line1_SF_plot = team_line1_matchups_pairings_df.plot.barh(x='MATCHUP', y='SF', stacked=True, color=line1_matchups_pairings_toi_color_map_for, width=line1_width, legend=None, label='', ax=ax_line1_shots);
        except:
            pass
        try:
            line1_SA_plot = team_line1_matchups_pairings_df.plot.barh(x='MATCHUP', y='SA', stacked=True, color=line1_matchups_pairings_toi_color_map_against, width=line1_width, legend=None, label='', ax=ax_line1_shots);
        except:
            pass
        try:
            line1_GF_marker = team_line1_matchups_pairings_df.plot(x='GF', y='RANK', marker='D', markersize=5,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_line1_shots);
        except:
            pass
        try:
            line1_GA_marker = team_line1_matchups_pairings_df.plot(x='GA', y='RANK', marker='D', markersize=5,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_line1_shots);
        except:
            pass
        try:
            line1_SD_plot = team_line1_matchups_pairings_df.plot(x='SD', y='RANK', marker='|', markersize=15,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_line1_shots);
        except:
            pass

        try:
            line2_SF_plot = team_line2_matchups_pairings_df.plot.barh(x='MATCHUP', y='SF', stacked=True, color=line2_matchups_pairings_toi_color_map_for, width=line2_width, legend=None, label='', ax=ax_line2_shots);
        except:
            pass
        try:
            line2_SA_plot = team_line2_matchups_pairings_df.plot.barh(x='MATCHUP', y='SA', stacked=True, color=line2_matchups_pairings_toi_color_map_against, width=line2_width, legend=None, label='', ax=ax_line2_shots);
        except:
            pass
        try:
            line2_GF_marker = team_line2_matchups_pairings_df.plot(x='GF', y='RANK', marker='D', markersize=5,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_line2_shots);
        except:
            pass
        try:
            line2_GA_marker = team_line2_matchups_pairings_df.plot(x='GA', y='RANK', marker='D', markersize=5,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_line2_shots);
        except:
            pass
        try:
            line2_SD_plot = team_line2_matchups_pairings_df.plot(x='SD', y='RANK', marker='|', markersize=15,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_line2_shots);
        except:
            pass

        try:
            line3_SF_plot = team_line3_matchups_pairings_df.plot.barh(x='MATCHUP', y='SF', stacked=True, color=line3_matchups_pairings_toi_color_map_for, width=line3_width, legend=None, label='', ax=ax_line3_shots);
        except:
            pass
        try:
            line3_SA_plot = team_line3_matchups_pairings_df.plot.barh(x='MATCHUP', y='SA', stacked=True, color=line3_matchups_pairings_toi_color_map_against, width=line3_width, legend=None, label='', ax=ax_line3_shots);
        except:
            pass
        try:
            line3_GF_marker = team_line3_matchups_pairings_df.plot(x='GF', y='RANK', marker='D', markersize=5,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_line3_shots);
        except:
            pass
        try:
            line3_GA_marker = team_line3_matchups_pairings_df.plot(x='GA', y='RANK', marker='D', markersize=5,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_line3_shots);
        except:
            pass
        try:
            line3_SD_plot = team_line3_matchups_pairings_df.plot(x='SD', y='RANK', marker='|', markersize=15,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_line3_shots);
        except:
            pass

        if len(team_line4_list) != 0:
            try:
                line4_SF_plot = team_line4_matchups_pairings_df.plot.barh(x='MATCHUP', y='SF', stacked=True, color=line4_matchups_pairings_toi_color_map_for, width=line4_width, legend=None, label='', ax=ax_line4_shots);
            except:
                pass
            try:
                line4_SA_plot = team_line4_matchups_pairings_df.plot.barh(x='MATCHUP', y='SA', stacked=True, color=line4_matchups_pairings_toi_color_map_against, width=line4_width, legend=None, label='', ax=ax_line4_shots);
            except:
                pass
            try:
                line4_GF_marker = team_line4_matchups_pairings_df.plot(x='GF', y='RANK', marker='D', markersize=5,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_line4_shots);
            except:
                pass
            try:
                line4_GA_marker = team_line4_matchups_pairings_df.plot(x='GA', y='RANK', marker='D', markersize=5,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_line4_shots);
            except:
                pass
            try:
                line4_SD_plot = team_line4_matchups_pairings_df.plot(x='SD', y='RANK', marker='|', markersize=15,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_line4_shots);
            except:
                pass

        # plot the bars for time on ice
        try:
            toi_line1 = team_line1_matchups_pairings_df.plot.barh(x='MATCHUP', y='TOI', color='white', edgecolor=team_color, width=line1_width, legend=None, label='', ax=ax_line1_toi);
        except:
            pass

        try:
            toi_line2 = team_line2_matchups_pairings_df.plot.barh(x='MATCHUP', y='TOI', color='white', edgecolor=team_color, width=line2_width, legend=None, label='', ax=ax_line2_toi);
        except:
            pass

        try:
            toi_line3 = team_line3_matchups_pairings_df.plot.barh(x='MATCHUP', y='TOI', color='white', edgecolor=team_color, width=line3_width, legend=None, label='', ax=ax_line3_toi);
        except:
            pass

        if len(team_line4_list) != 0:
            try:
                toi_line4 = team_line4_matchups_pairings_df.plot.barh(x='MATCHUP', y='TOI', color='white', edgecolor=team_color, width=line4_width, legend=None, label='', ax=ax_line4_toi);
            except:
                pass
        ...
        SF_max = lines_matchups_pairings_df['SF']
        SF_max = SF_max.max()
        
        SA_max = lines_matchups_pairings_df['SA']
        SA_max = SA_max.max()
        ...
        if team == away:
            plt.savefig(charts_units_lines_matchups + 'onice_shots_away_lines_matchups_pairings.png', bbox_inches='tight', pad_inches=0.2)
        elif team == home:
            plt.savefig(charts_units_lines_matchups + 'onice_shots_home_lines_matchups_pairings.png', bbox_inches='tight', pad_inches=0.2)    
