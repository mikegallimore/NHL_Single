...
def parse_ids(season_id, game_id, images):
    ...
    for team in teams:
        ...
        team_pairings_teammates_lines_df['SA'] *= -1
        ...
        # set the plot title
        fig.suptitle(date + ' Pairings + Lines On-Ice Shots\n\n')
        ...
        try:
            pairing1_SF_plot = team_pairing1_teammates_lines_df.plot.barh(x='LINE', y='SF', stacked=True, color=pairing1_teammates_lines_toi_color_map_for, width=pairing1_width, legend=None, label='', ax=ax_pairing1_shots);
        except:
            pass
        try:
            pairing1_SA_plot = team_pairing1_teammates_lines_df.plot.barh(x='LINE', y='SA', stacked=True, color=pairing1_teammates_lines_toi_color_map_against, width=pairing1_width, legend=None, label='', ax=ax_pairing1_shots);
        except:
            pass
        try:
            pairing1_GF_marker = team_pairing1_teammates_lines_df.plot(x='GF', y='RANK', marker='D', markersize=5,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_pairing1_shots);
        except:
            pass
        try:
            pairing1_GA_marker = team_pairing1_teammates_lines_df.plot(x='GA', y='RANK', marker='D', markersize=5,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_pairing1_shots);
        except:
            pass
        try:
            pairing1_SD_plot = team_pairing1_teammates_lines_df.plot(x='SD', y='RANK', marker='|', markersize=15,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_pairing1_shots);
        except:
            pass

        try:
            pairing2_SF_plot = team_pairing2_teammates_lines_df.plot.barh(x='LINE', y='SF', stacked=True, color=pairing2_teammates_lines_toi_color_map_for, width=pairing2_width, legend=None, label='', ax=ax_pairing2_shots);
        except:
            pass
        try:
            pairing2_SA_plot = team_pairing2_teammates_lines_df.plot.barh(x='LINE', y='SA', stacked=True, color=pairing2_teammates_lines_toi_color_map_against, width=pairing2_width, legend=None, label='', ax=ax_pairing2_shots);
        except:
            pass
        try:
            pairing2_GF_marker = team_pairing1_teammates_lines_df.plot(x='GF', y='RANK', marker='D', markersize=5,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_pairing2_shots);
        except:
            pass
        try:
            pairing2_GA_marker = team_pairing1_teammates_lines_df.plot(x='GA', y='RANK', marker='D', markersize=5,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_pairing2_shots);
        except:
            pass
        try:
            pairing2_SD_plot = team_pairing2_teammates_lines_df.plot(x='SD', y='RANK', marker='|', markersize=15,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_pairing2_shots);
        except:
            pass

        try:
            pairing3_SF_plot = team_pairing3_teammates_lines_df.plot.barh(x='LINE', y='SF', stacked=True, color=pairing3_teammates_lines_toi_color_map_for, width=pairing3_width, legend=None, label='', ax=ax_pairing3_shots);
        except:
            pass
        try:
            pairing3_SA_plot = team_pairing3_teammates_lines_df.plot.barh(x='LINE', y='SA', stacked=True, color=pairing3_teammates_lines_toi_color_map_against, width=pairing3_width, legend=None, label='', ax=ax_pairing3_shots);
        except:
            pass
        try:
            pairing3_GF_marker = team_pairing1_teammates_lines_df.plot(x='GF', y='RANK', marker='D', markersize=5,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_pairing3_shots);
        except:
            pass
        try:
            pairing3_GA_marker = team_pairing1_teammates_lines_df.plot(x='GA', y='RANK', marker='D', markersize=5,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_pairing3_shots);
        except:
            pass
        try:
            pairing3_SD_plot = team_pairing3_teammates_lines_df.plot(x='SD', y='RANK', marker='|', markersize=15,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_pairing3_shots);
        except:
            pass

        # plot the bars for time on ice
        try:
            toi_pairing1 = team_pairing1_teammates_lines_df.plot.barh(x='PAIRING', y='TOI', color='white', edgecolor=team_color, width=pairing1_width, legend=None, label='', ax=ax_pairing1_toi);
        except:
            pass

        try:
            toi_pairing2 = team_pairing2_teammates_lines_df.plot.barh(x='PAIRING', y='TOI', color='white', edgecolor=team_color, width=pairing2_width, legend=None, label='', ax=ax_pairing2_toi);
        except:
            pass

        try:
            toi_pairing3 = team_pairing3_teammates_lines_df.plot.barh(x='PAIRING', y='TOI', color='white', edgecolor=team_color, width=pairing3_width, legend=None, label='', ax=ax_pairing3_toi);
        except:
            pass
        ...
        SF_max = pairings_teammates_lines_df['SF']
        SF_max = SF_max.max()
        
        SA_max = pairings_teammates_lines_df['SA']
        SA_max = SA_max.max()
        ...
        if team == away:
            plt.savefig(charts_units_pairings_teammates + 'onice_shots_away_pairings_teammates_lines.png', bbox_inches='tight', pad_inches=0.2)
        elif team == home:
            plt.savefig(charts_units_pairings_teammates + 'onice_shots_home_pairings_teammates_lines.png', bbox_inches='tight', pad_inches=0.2)    
