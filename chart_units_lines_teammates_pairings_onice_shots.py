...
def parse_ids(season_id, game_id, images):
    ...
    for team in teams:
        ...
        axarr[0].set_title(date + ' Lines + Pairings 5v5 On-Ice Shots\n' + away + ' @ ' + home + '\n\n' + team_lines_list[3], size=10, loc='center')
        ...
        try:
            line1_SF_plot = team_line1_teammates_pairings_df.plot.barh(x='PAIRING', y='SF', stacked=True, color=line1_teammates_pairings_toi_color_map_for, width=0.5, legend=None, label='', ax=axarr[0]);
        except:
            pass
        try:
            line1_SA_plot = team_line1_teammates_pairings_df.plot.barh(x='PAIRING', y='SA', stacked=True, color=line1_teammates_pairings_toi_color_map_against, width=0.5, legend=None, label='', ax=axarr[0]);
        except:
            pass
        try:
            line1_SD_plot = team_line1_teammates_pairings_df.plot(x='SD', y='RANK', marker='o', color='white', markersize=7, markeredgecolor='black', linewidth=0, alpha=1, legend=None, label='', ax=axarr[0]);
        except:
            pass

        try:
            line2_SF_plot = team_line2_teammates_pairings_df.plot.barh(x='PAIRING', y='SF', stacked=True, color=line2_teammates_pairings_toi_color_map_for, width=0.5, legend=None, label='', ax=axarr[1]);
        except:
            pass
        try:
            line2_SA_plot = team_line2_teammates_pairings_df.plot.barh(x='PAIRING', y='SA', stacked=True, color=line2_teammates_pairings_toi_color_map_against, width=0.5, legend=None, label='', ax=axarr[1]);
        except:
            pass
        try:
            line2_SD_plot = team_line2_teammates_pairings_df.plot(x='SD', y='RANK', marker='o', color='white', markersize=7, markeredgecolor='black', linewidth=0, alpha=1, legend=None, label='', ax=axarr[1]);
        except:
            pass

        try:
            line3_SF_plot = team_line3_teammates_pairings_df.plot.barh(x='PAIRING', y='SF', stacked=True, color=line3_teammates_pairings_toi_color_map_for, width=0.5, legend=None, label='', ax=axarr[2]);
        except:
            pass
        try:
            line3_SA_plot = team_line3_teammates_pairings_df.plot.barh(x='PAIRING', y='SA', stacked=True, color=line3_teammates_pairings_toi_color_map_against, width=0.5, legend=None, label='', ax=axarr[2]);
        except:
            pass
        try:
            line3_SD_plot = team_line3_teammates_pairings_df.plot(x='SD', y='RANK', marker='o', color='white', markersize=7, markeredgecolor='black', linewidth=0, alpha=1, legend=None, label='', ax=axarr[2]);
        except:
            pass

        try:
            line4_SF_plot = team_line4_teammates_pairings_df.plot.barh(x='PAIRING', y='SF', stacked=True, color=line4_teammates_pairings_toi_color_map_for, width=0.5, legend=None, label='', ax=axarr[3]);
        except:
            pass
        try:
            line4_SA_plot = team_line4_teammates_pairings_df.plot.barh(x='PAIRING', y='SA', stacked=True, color=line4_teammates_pairings_toi_color_map_against, width=0.5, legend=None, label='', ax=axarr[3]);
        except:
            pass
        try:
            line4_SD_plot = team_line4_teammates_pairings_df.plot(x='SD', y='RANK', marker='o', color='white', markersize=7, markeredgecolor='black', linewidth=0, alpha=1, legend=None, label='', ax=axarr[3]);
        except:
            pass
        ...
        SF_max = team_lines_teammates_pairings_df['SF']
        SF_max = SF_max.max()
        SA_max = team_lines_teammates_pairings_df['SA']
        SA_max *= -1
        SA_max = SA_max.max()
        ...
        line1_color_bar.ax.set_yticklabels(['0', '', max_line1_teammates_pairings_toi], fontsize=10)
        ...
        line2_color_bar.ax.set_yticklabels(['0', '', max_line2_teammates_pairings_toi], fontsize=10)
        ...
        line3_color_bar.ax.set_yticklabels(['0', '', max_line3_teammates_pairings_toi], fontsize=10)
        ...
        try:
            ...
            line4_color_bar.ax.set_yticklabels(['0', '', max_line4_teammates_pairings_toi], fontsize=10)
        ...
        if team == away:
            plt.savefig(charts_units + 'onice_shots_away_lines_teammates_pairings.png', bbox_inches='tight', pad_inches=0.2)
        elif team == home:
            plt.savefig(charts_units + 'onice_shots_home_lines_teammates_pairings.png', bbox_inches='tight', pad_inches=0.2)    
