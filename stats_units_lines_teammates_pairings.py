...
def parse_ids(season_id, game_id):
    ...
    stats_individual = files_root + 'stats_units_lines_individual_teammates_pairings.csv'
    stats_onice = files_root + 'stats_units_lines_onice_teammates_pairings.csv'
    ...
    with open(stats_individual, 'w', newline = '') as players_individual, open(stats_onice, 'w', newline = '') as players_onice:
        ...
        individual_out.writerow(['SEASON', 'GAME_ID', 'DATE', 'LOCATION', 'TEAM', 'FORWARD_1', 'FORWARD_2', 'FORWARD_3', 'LINE', 'DEFENDER_1', 'DEFENDER_2', 'PAIRING', 'STATE', 'GP', 'TOI', 'G', 'xG', 'A', '1_A', 'PTS', '1_PTS', 'ONS', 'US', 'S'])
    
        onice_out = csv.writer(players_onice)
        onice_out.writerow(['SEASON', 'GAME_ID', 'DATE', 'LOCATION', 'TEAM', 'FORWARD_1', 'FORWARD_2', 'FORWARD_3', 'LINE', 'DEFENDER_1', 'DEFENDER_2', 'PAIRING', 'STATE', 'GP', 'TOI', 'GF', 'GA', 'xGF', 'xGA', 'ONSF', 'ONSA', 'USF', 'USA', 'SF', 'SA', 'GD', 'xGD', 'ONSD', 'USD', 'SD', 'FO'])
            ...
            for t_line in team_lines:
                ...
                for t_pairing in team_pairings:
                    ...
                    G_5v5 = (pbp_df[(pbp_df['TEAM'] == team) & (pbp_df['EVENT_TYPE'] == event) & (pbp_df[team_strength] == '5v5') &
                            ...
                            (pbp_df[teamON].str.contains(team_forward_3)) &
                            (pbp_df[teamON].str.contains(team_defender_1)) &
                            (pbp_df[teamON].str.contains(team_defender_2))].count()[1] +
                    ...
                    xG_5v5 = (round(np.where((pbp_df['TEAM'] == team) & (pbp_df['EVENT'] == 'Shot') & (pbp_df['EVENT_TYPE'] != 'Block') & (pbp_df[team_strength] == '5v5') &
                                             ...
                                             (pbp_df[teamON].str.contains(team_forward_3)) &
                                             (pbp_df[teamON].str.contains(team_defender_1)) &
                                             (pbp_df[teamON].str.contains(team_defender_2)), pbp_df['xG'], 0).sum() +
                                    ...
                                    np.where((pbp_df['TEAM'] == team) & (pbp_df['EVENT'] == 'Shot') & (pbp_df['EVENT_TYPE'] != 'Block') & (pbp_df[team_strength] == '5v5') &
                                             ...
                                             (pbp_df[teamON].str.contains(team_forward_2)) &
                                             (pbp_df[teamON].str.contains(team_defender_1)) &
                                             (pbp_df[teamON].str.contains(team_defender_2)), pbp_df['xG'], 0).sum(), 2)
                                )
                    ...
                    individual_out.writerow((season_id, game_id, date, team_text, team, team_forward_1, team_forward_2, team_forward_3, team_line_lastname, team_defender_1, team_defender_2, team_pair_lastname, '5v5', '1', toi_5v5) + individual_5v5)
                    
                    # status update
                    print('Processing ' + team + ' individual stats for ' + team_line_lastname + ' with ' + team_pair_lastname)
    
                    # write out on-ice line matchup data
                    onice_out.writerow((season_id, game_id, date, team_text, team, team_forward_1, team_forward_2, team_forward_3, team_line_lastname, team_defender_1, team_defender_2, team_pair_lastname, '5v5', '1', toi_5v5) + onice_5v5)
                    
                    # status update
                    print('Processing ' + team + ' on-ice player stats for ' + team_line_lastname + ' with ' + team_pair_lastname)
    
    # status update
    print('Finished generating line with pairing stats for ' + season_id + ' ' + game_id)