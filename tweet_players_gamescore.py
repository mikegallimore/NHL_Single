...
def parse_ids(season_id, game_id):
    ...
    players_gamescores_away = open(charts_players + 'gamescores_away.png', 'rb')
    players_gamescores_home = open(charts_players + 'gamescores_home.png', 'rb')
    ...
    images = [players_gamescores_away, players_gamescores_home]
