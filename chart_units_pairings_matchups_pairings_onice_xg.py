...
def parse_ids(season_id, game_id, images):
    ...
    for team in teams:
        ...
        team_pairings_matchups_pairings_df['xGF'] = team_pairings_matchups_pairings_df['xGF'].replace(0, np.NaN)       
        team_pairings_matchups_pairings_df['xGA'] = team_pairings_matchups_pairings_df['xGA'].replace(0, np.NaN)
