...
def parse_ids(season_id, game_id, images):
    ...
    for team in teams:
        ...
        team_pairings_matchups_lines_df['xGD'] = team_pairings_matchups_lines_df['xGD'].replace(0, np.NaN)       

        # make expected goals against negative values 
        team_pairings_matchups_lines_df['xGA'] *= -1
        ...
        # set the plot title
        fig.suptitle(date + ' Pairings vs. Lines On-Ice Expected Goals\n\n')
        ...
        try:
            pairing1_xGF_plot = team_pairing1_matchups_lines_df.plot.barh(x='MATCHUP', y='xGF', stacked=True, color=pairing1_matchups_lines_toi_color_map_for, width=pairing1_width, legend=None, label='', ax=ax_pairing1_xG);
        except:
            pass
        try:
            pairing1_xGA_plot = team_pairing1_matchups_lines_df.plot.barh(x='MATCHUP', y='xGA', stacked=True, color=pairing1_matchups_lines_toi_color_map_against, width=pairing1_width, legend=None, label='', ax=ax_pairing1_xG);
        except:
            pass
        try:
            pairing1_xGD_plot = team_pairing1_matchups_lines_df.plot(x='xGD', y='RANK', marker='|', markersize=15,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_pairing1_xG);
        except:
            pass

        try:
            pairing2_xGF_plot = team_pairing2_matchups_lines_df.plot.barh(x='MATCHUP', y='xGF', stacked=True, color=pairing2_matchups_lines_toi_color_map_for, width=pairing2_width, legend=None, label='', ax=ax_pairing2_xG);
        except:
            pass
        try:
            pairing2_xGA_plot = team_pairing2_matchups_lines_df.plot.barh(x='MATCHUP', y='xGA', stacked=True, color=pairing2_matchups_lines_toi_color_map_against, width=pairing2_width, legend=None, label='', ax=ax_pairing2_xG);
        except:
            pass
        try:
            pairing2_xGD_plot = team_pairing2_matchups_lines_df.plot(x='xGD', y='RANK', marker='|', markersize=15,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_pairing2_xG);
        except:
            pass

        try:
            pairing3_xGF_plot = team_pairing3_matchups_lines_df.plot.barh(x='MATCHUP', y='xGF', stacked=True, color=pairing3_matchups_lines_toi_color_map_for, width=pairing3_width, legend=None, label='', ax=ax_pairing3_xG);
        except:
            pass
        try:
            pairing3_xGA_plot = team_pairing3_matchups_lines_df.plot.barh(x='MATCHUP', y='xGA', stacked=True, color=pairing3_matchups_lines_toi_color_map_against, width=pairing3_width, legend=None, label='', ax=ax_pairing3_xG);
        except:
            pass
        try:
            pairing3_xGD_plot = team_pairing3_matchups_lines_df.plot(x='xGD', y='RANK', marker='|', markersize=15,  markerfacecolor='None', markeredgecolor='white', linewidth=0, alpha=1, legend=None, label='', ax=ax_pairing3_xG);
        except:
            pass
        ...
        xGF_max = pairings_matchups_lines_df['xGF']
        xGF_max = xGF_max.max()
        
        xGA_max = pairings_matchups_lines_df['xGA']
        xGA_max = xGA_max.max()
        ...
        if team == away:
            plt.savefig(charts_units_pairings_matchups + 'onice_xg_away_pairings_matchups_lines.png', bbox_inches='tight', pad_inches=0.2)
        elif team == home:
            plt.savefig(charts_units_pairings_matchups + 'onice_xg_home_pairings_matchups_lines.png', bbox_inches='tight', pad_inches=0.2)    
        ...
        # status update
        print('Plotting ' + team + ' pairings vs. lines 5v5 on-ice xG.')   
        
    # status update   
    print('Finished plotting the 5v5 on-ice xG for pairings vs. lines.')