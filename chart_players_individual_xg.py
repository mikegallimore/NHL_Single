...
def parse_ids(season_id, game_id, images):
    ...
    for team in teams:
        ...
        # set the plot title
        fig.suptitle(date + ' Skaters Individual Expected Goals\n\n')       
...
#        ax.axvspan(0, 0, ymin=0, ymax=1, alpha=1, color='white')
        ...
        if team == away:
            plt.savefig(charts_players_individual + 'skaters_individual_xG_away.png', bbox_inches='tight', pad_inches=0.2)
        elif team == home:
            plt.savefig(charts_players_individual + 'skaters_individual_xG_home.png', bbox_inches='tight', pad_inches=0.2)    
        ...
        # status update
        print('Plotting ' + team + ' skaters individual xG.')   
        
    # status update
    print('Finished plotting the individual xG for skaters.')