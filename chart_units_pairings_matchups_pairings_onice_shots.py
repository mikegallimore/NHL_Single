...
def parse_ids(season_id, game_id, images):
    ...
    for team in teams:
        ...
        axarr[0].set_title(date + ' Pairings vs Pairings 5v5 On-Ice Shots\n' + away + ' @ ' + home + '\n\n' + team_pairings_list[2], size=10, loc='center')
        axarr[1].set_title(team_pairings_list[1], size=10, loc='center')
        axarr[2].set_title(team_pairings_list[0], size=10, loc='center')
        
        ### create bars for shots for and against as well as line markers (to note the shot differential) for each line
        try:
            pairing1_SF_plot = team_pairing1_matchups_pairings_df.plot.barh(x='MATCHUP', y='SF', stacked=True, color=pairing1_matchups_pairings_toi_color_map_for, width=0.5, legend=None, label='', ax=axarr[0]);
        except:
            pass
        try:
            pairing1_SA_plot = team_pairing1_matchups_pairings_df.plot.barh(x='MATCHUP', y='SA', stacked=True, color=pairing1_matchups_pairings_toi_color_map_against, width=0.5, legend=None, label='', ax=axarr[0]);
        except:
            pass
        try:
            pairing1_SD_plot = team_pairing1_matchups_pairings_df.plot(x='SD', y='RANK', marker='o', color='white', markersize=7, markeredgecolor='black', linewidth=0, alpha=1, legend=None, label='', ax=axarr[0]);
        except:
            pass

        try:
            pairing2_SF_plot = team_pairing2_matchups_pairings_df.plot.barh(x='MATCHUP', y='SF', stacked=True, color=pairing2_matchups_pairings_toi_color_map_for, width=0.5, legend=None, label='', ax=axarr[1]);
        except:
            pass
        try:
            pairing2_SA_plot = team_pairing2_matchups_pairings_df.plot.barh(x='MATCHUP', y='SA', stacked=True, color=pairing2_matchups_pairings_toi_color_map_against, width=0.5, legend=None, label='', ax=axarr[1]);
        except:
            pass
        try:
            pairing2_SD_plot = team_pairing2_matchups_pairings_df.plot(x='SD', y='RANK', marker='o', color='white', markersize=7, markeredgecolor='black', linewidth=0, alpha=1, legend=None, label='', ax=axarr[1]);
        except:
            pass

        try:
            pairing3_SF_plot = team_pairing3_matchups_pairings_df.plot.barh(x='MATCHUP', y='SF', stacked=True, color=pairing3_matchups_pairings_toi_color_map_for, width=0.5, legend=None, label='', ax=axarr[2]);
        except:
            pass
        try:
            pairing3_SA_plot = team_pairing3_matchups_pairings_df.plot.barh(x='MATCHUP', y='SA', stacked=True, color=pairing3_matchups_pairings_toi_color_map_against, width=0.5, legend=None, label='', ax=axarr[2]);
        except:
            pass
        try:
            pairing3_SD_plot = team_pairing3_matchups_pairings_df.plot(x='SD', y='RANK', marker='o', color='white', markersize=7, markeredgecolor='black', linewidth=0, alpha=1, legend=None, label='', ax=axarr[2]);
        except:
            pass
        ...
        SF_max = team_pairings_matchups_pairings_df['SF']
        SF_max = SF_max.max()
        SA_max = team_pairings_matchups_pairings_df['SA']
        SA_max *= -1
        SA_max = SA_max.max()
        ...
        try:
            ...
            pairing1_color_bar.ax.set_yticklabels(['0', '', max_pairing1_matchups_pairings_toi], fontsize=10)
        ...
        try:
            ...
            pairing2_color_bar.ax.set_yticklabels(['0', '', max_pairing2_matchups_pairings_toi], fontsize=10)
        ...
        try:
            ...
            pairing3_color_bar.ax.set_yticklabels(['0', '', max_pairing3_matchups_pairings_toi], fontsize=10)
        ...
        if team == away:
            plt.savefig(charts_units + 'onice_shots_away_pairings_matchups_pairings.png', bbox_inches='tight', pad_inches=0.2)
        elif team == home:
            plt.savefig(charts_units + 'onice_shots_home_pairings_matchups_pairings.png', bbox_inches='tight', pad_inches=0.2)    
