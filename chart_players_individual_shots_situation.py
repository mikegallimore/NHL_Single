...
def parse_ids(season_id, game_id, images):
    ...
    for situation in situations:
        ...
        for team in teams:
            ...
            # set the plot title
            if team == away:
                fig.suptitle(date + ' Skaters Individual Shots (Away ' + situation + ')\n\n')       
            if team == home:
                fig.suptitle(date + ' Skaters Individual Shots (Home ' + situation + ')\n\n')       
            ...
            if team == away:
                plt.savefig(charts_players_individual_situation + 'skaters_individual_shots_away_' + situation.lower() + '.png', bbox_inches='tight', pad_inches=0.2)
            elif team == home:
                plt.savefig(charts_players_individual_situation + 'skaters_individual_shots_home_' + situation.lower() + '.png', bbox_inches='tight', pad_inches=0.2)    
            ...
            # status update
            print('Plotting ' + team + ' skaters individual shots while ' + situation.lower() + '.')   
        
    # status update
    print('Finished plotting the individual shots for skaters by situation.')